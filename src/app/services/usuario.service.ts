...
export class UsuarioService {
  ...
  addUsuario(usuario:usuario){
    return this.http.post<usuario>(this.ruta_servidor+"/"+this.recurso, usuario);
  }
  updateUsuario(usuario:usuario){
    return this.http.put<usuario>(this.ruta_servidor+"/"+this.recurso+"/"+usuario.id.toString(), usuario);
  }
